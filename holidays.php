...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">უქმე დღეები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">უქმე დღეები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	<div title="უქმე დღე" id="get_edit_page">
	...
	function LoadKendoTable_incomming(hidden){
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_holidays',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
	...
	function save_category(){
		...
		params.act 			= 'save_holiday';
		params.id 			= $("#holiday_id").val();
		params.tarigi 	= $("#tarigi").val();
		params.h_name 	= $("#h_name").val();
