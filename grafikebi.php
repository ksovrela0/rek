...
<body class="main-body main-sidebar-hide">
		...
		<div class="main-content side-content pt-0">
			...
			<div class="container-fluid">
				...
				<div class="page-header">
					<div>
						<h2 class="main-content-title tx-24 mg-b-5">სამუშაო გრაფიკები</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="#">პარამეტრები</a></li>
							<li class="breadcrumb-item active" aria-current="page">სამუშაო გრაფიკები</li>
						</ol>
					</div>
				</div>
				<!-- End Page Header -->
	...
	<div title="გრაფიკი" id="get_edit_page">
	...
	function LoadKendoTable_incomming(hidden){
		...
		const kendo = new kendoUI();
		kendo.loadKendoUI(aJaxURL,'get_list_sch',itemPerPage,columnsCount,columnsSQL,gridName,actions,editType,columnGeoNames,filtersCustomOperators,showOperatorsByColumns,selectors,hidden, 1, locked, lockable);
	...
	function save_category(){
		...
		params.act 			= 'save_grafik';
		params.id 			= $("#grafik_id").val();
		params.grafik_name 	= $("#grafik_name").val();
		params.location_addr 	= $("#location_addr").val();
		params.plan_in	= $("#plan_in").val();
		params.min_working_minutes 		= $("#min_working_minutes").val();
		params.latecome 	= $("#latecome").val();
		params.working_minutes 	= $("#working_minutes").val();

		params.vacation_days 	= $("#vacation_days").val();
